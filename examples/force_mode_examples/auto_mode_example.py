...
async def main():
    try:
        ...
        # Set auto mode (this is the default, but we set it explicitly for clarity)
        os.environ['FORCE_MODE'] = 'auto'
        logger.info("Setting FORCE_MODE=auto (letting the LLM decide)")
        ...
        if use_group_chat:
            ...
            logger.info("Starting group chat with auto mode...")
            ...
            logger.info("Starting direct agent conversation with auto mode...")
